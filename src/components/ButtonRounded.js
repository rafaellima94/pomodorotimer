...
const Button = styled.button`
    ...
    margin: 10px;
    background-color: ${props => props.outlined ? '#FFFFFF' : props.color ? props.color : '#000'};
    ...
    outline: none;
    border: ${props => props.outlined ? `2px solid ${props.outlined}` : 'none'};
    ...
    &:hover {
        ...
        ${props => !props.disabled && `background-color: ${props => props.outlined ? '#f2f2f2' : props.color ? props.color : '#000'};`}
    }
`;
...
export default function ButtonRounded(props) {
    return (
        <Button type={props.type} onClick={props.click} padding={props.padding} outlined={props.outlined} color={props.color} disabled={props.disabled && true} width={props.width}>
            <ButtonTitle>
                {props.title}
            </ButtonTitle>
        </Button>
